...
namespace Standard.ToLyst.Model.Constants
{
    public static class RegexPatterns
    {
        ...
        public static string SEARCHER_AUCHAN_UNIT = "<span class=\"[\\w|\\-]*price-per-unit\">(\\d*.\\d*[^\\d]*)<\\/span>";
        public static string SEARCHER_AUCHAN_PID = "<div.+class=\"product\".+data-pid=\"(\\d+)\">";
        ...
        public static string SEARCHER_CONTINENTE_MEDIA = "<img.+src=(?:\")(.+?)(?:\")(?:.+?)>";
    }
}
